...
carCascade = cv2.CascadeClassifier(r'C:/Users/sricharan namburi/OneDrive/Desktop/vehicle-speed-detection-master/files/HaarCascadeClassifier.xml')

#TAKE VIDEO---------------------------------------------------------------------
video = cv2.VideoCapture(r"C:\Users\sricharan namburi\OneDrive\Desktop\test videos\VID_20230417_181339.mp4")
...
markGap = 35 #DISTANCE IN METRES BETWEEN THE MARKERS
fpsFactor = 6 #TO COMPENSATE FOR SLOW PROCESSING
...
if not os.path.exists(r"C:/Users/sricharan namburi/OneDrive/Desktop/vehicle-speed-detection-master/overspeeding/cars"):
    os.makedirs(r"C:/Users/sricharan namburi/OneDrive/Desktop/vehicle-speed-detection-master/overspeeding/cars")
...
def saveCar(speed,image):
    ...
    link = r"C:/Users/sricharan namburi/OneDrive/Desktop/vehicle-speed-detection-master/overspeeding/cars"+nameCurTime+'.jpg'
